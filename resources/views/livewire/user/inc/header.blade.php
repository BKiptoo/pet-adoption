            ...
            <div class="flex items-center gap-4">
                ...
                <div
                    ...
                    <input type="text" name="header-search" placeholder="Search..."
                        class="bg-transparent pl-[36px] pr-12 py-4 dk-border-one rounded-full w-full font-spline_sans focus:outline-none focus:border-primary-500 dk-theme-card-square">
                    <span
            ...
            <div class="flex items-center gap-1 sm:gap-3">
                ...
                <div class="relative">
                    <button type="button" data-popover-target="dropdownProfile" data-popover-trigger="click"
                        ...
                        <span class="font-semibold leading-none text-lg capitalize hidden sm:block">{{ $user ? substr($user->name, 0, 5) . '..' : 'Guest' }}</span>
                    </button>
                    <!-- Dropdown menu -->
